...
export const DEFAULT_SETTINGS = {
  ...
  seekTemplateMaxPlacementDistance: {
    name: 'PF2E_VISIONER.SETTINGS.SEEK_TEMPLATE_MAX_PLACEMENT_DISTANCE.name',
    hint: 'PF2E_VISIONER.SETTINGS.SEEK_TEMPLATE_MAX_PLACEMENT_DISTANCE.hint',
    scope: 'world',
    config: true,
    restricted: true,
    type: Number,
  ...
  flankingSizeRule: {
    ...
    choices: {
      ...
      oppositeArcs: 'PF2E_VISIONER.SETTINGS.FLANKING_SIZE_RULE.CHOICES.oppositeArcs',
  ...
  autoCoverIgnoreSameSizeTokens: {
    name: 'PF2E_VISIONER.SETTINGS.AUTO_COVER_IGNORE_SAME_SIZE_TOKENS.name',
    hint: 'PF2E_VISIONER.SETTINGS.AUTO_COVER_IGNORE_SAME_SIZE_TOKENS.hint',
    scope: 'world',
    config: true,
    restricted: true,
    type: Boolean,
  ...
  autoCoverIgnoreLargerTokens: {
    name: 'PF2E_VISIONER.SETTINGS.AUTO_COVER_IGNORE_LARGER_TOKENS.name',
    hint: 'PF2E_VISIONER.SETTINGS.AUTO_COVER_IGNORE_LARGER_TOKENS.hint',
    scope: 'world',
    config: true,
    restricted: true,
    type: Boolean,

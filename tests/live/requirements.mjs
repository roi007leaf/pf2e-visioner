...
export const requirements = [
  ...
  ['Rendered indicators and tiles', ['hearing-tremorsense-rendered-transitions', 'scent-preserves-rendered-background-tile']],
  ...
  ['Movement', ['door-close-open-close', 'drag-preview', 'movement-animation-performance']],
